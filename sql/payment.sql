...
CREATE TABLE `user_deduct_info_wechat` (
      ...
      `dog_id` bigint(20) NOT NULL DEFAULT '0',
...
alter table user_deduct_info add CONSTRAINT `uk_dog_id_channel` UNIQUE (`dog_id`, `channel`);
alter table user_deduct_info drop index uk_dog_id;
